...
function buildMenu($menu, $parentid = 0){
    ...
    foreach ($menu as $item)
        if ($item->parent_id == $parentid) {
            ...
            $result .= "<div class='actions'><a href='/admin/videos/categories/edit/{$item->cat_id}' class='edit'>Edit</a> <a href='/admin/videos/categories/delete/{$item->cat_id}' class='delete'>Delete</a></div>";
